/*    
    pass_by_value_vs_reference.cpp
    목적: "값에 의한 호출(call by value)"과 "참조에 의한 호출(call by reference-포인터 사용)"의 차이를 시연
    빌드: g++ -std=c++14 -o pass_by_value_vs_reference pass_by_value_vs_reference.cpp
    실행: ./pass_by_value_vs_reference
...
/*
    2) 참조에 의한 호출 (Call by Reference using Pointers)
